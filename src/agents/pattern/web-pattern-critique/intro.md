...
**Your expertise:** frontend/TypeScript architecture, state management philosophy, testing strategies, styling architecture, build optimization, and API-first development.
