...
async function testFrameworkPath(
  ...
  for (const topCatId of topCategories) {
    ...
    for (const subCatId of subcategories) {
      ...
      const enabledSkills = availableSkills.filter(
        (s) => !s.disabled && !s.selected,
      );
...
async function testConflicts(matrix: MergedSkillsMatrix) {
  ...
  for (const conflict of conflicts) {
    ...
    if (!validation.valid) {
      passCount++;
      log(
        `  ✓ ${conflict.a} + ${conflict.b}: Correctly rejected (${conflict.reason})`,
      );
    } else {
      failCount++;
      log(
        `  ✗ ${conflict.a} + ${conflict.b}: Should be rejected (${conflict.reason})`,
      );
    }
  }
}
...
async function testReactStackPaths(matrix: MergedSkillsMatrix) {
  ...
  const paths = [
    ...
    { name: "React + Zustand", skills: ["react", "scss-modules", "zustand"] },
    {
      ...
      skills: ["react", "scss-modules", "zustand", "react-query"],
    },
    {
      name: "React + Forms",
      skills: [
    ...
    },
    {
      ...
      skills: ["react", "tailwind", "shadcn-ui", "zustand", "react-query"],
    },
    {
      name: "React + Backend",
      skills: ["react", "scss-modules", "hono", "drizzle"],
    },
    {
      name: "React + Backend + Auth",
      skills: ["react", "scss-modules", "hono", "drizzle", "better-auth"],
    },
  ];
...
async function testVueStackPaths(matrix: MergedSkillsMatrix) {
  ...
  const paths = [
    ...
    {
      name: "Vue + Testing",
      skills: ["vue", "scss-modules", "pinia", "vitest", "vue-test-utils"],
    },
    { name: "Vue + Nuxt", skills: ["vue", "nuxt", "tailwind", "pinia"] },
    {
      name: "Vue + Backend",
      skills: ["vue", "scss-modules", "hono", "drizzle"],
    },
  ];
...
async function testAngularStackPaths(matrix: MergedSkillsMatrix) {
  ...
  const paths = [
    ...
    {
      name: "Angular + NgRx",
      skills: ["angular", "scss-modules", "ngrx-signalstore"],
    },
    {
      name: "Angular + Testing",
      skills: ["angular", "scss-modules", "vitest", "playwright-e2e"],
    },
    {
      name: "Angular + Backend",
      skills: ["angular", "scss-modules", "hono", "drizzle"],
    },
  ];
...
async function testSolidJSStackPaths(matrix: MergedSkillsMatrix) {
  ...
  const paths = [
    ...
    {
      name: "SolidJS + Backend",
      skills: ["solidjs", "tailwind", "hono", "drizzle"],
    },
  ];
...
async function testMobilePaths(matrix: MergedSkillsMatrix) {
  ...
  const paths = [
    ...
    { name: "React Native + Zustand", skills: ["react-native", "zustand"] },
    {
      ...
      skills: ["react-native", "zustand", "react-query"],
    },
    {
