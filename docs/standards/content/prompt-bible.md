...
> **Note:** This document covers universal prompt engineering techniques that work for any Claude agent system. For implementation-specific details about THIS system (directory structure, build system, adding agents), see [claude-architecture-bible.md](./claude-architecture-bible.md).
