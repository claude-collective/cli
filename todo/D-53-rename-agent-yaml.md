...
| File                               | What                        | Note                                                                                                                                                                           |
| ---------------------------------- | --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `src/schemas/agent.schema.json`    | JSON schema file            | Keep filename as `agent.schema.json` -- this is the schema _for_ agents, not the filename being validated. The `$id` and `description` mention "agent.yaml" and need updating. |
...
- `agent.schema.json` -- this is the JSON schema _for_ agent definitions, not the file it validates
