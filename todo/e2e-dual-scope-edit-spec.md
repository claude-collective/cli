...
**What it proves:** After editing a plugin-mode project to switch _some_ skills to local, both source types coexist correctly — local skills have files on disk, plugin skills remain registered, and the config reflects the mixed state.
